...
import com.tugassensor2023akbif510120205.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BottomNavigationView bottomNavigationView = binding.bottomNavigationViewMap;
                ...
                for (Location location : locationResult.getLocations()) {
                    if (location != null) {
                        ...
                        StringBuilder stringBuilder = new StringBuilder("https://serpapi.com/search.json?" +
                                ...
                                "ll=@" + lat + "," + lng + ",15.1z&" +
                                "type=search" +
                                "&api_key=48b049d1f57afaa413a97acc05f1b92239b1a1a3a605dcb78edd83d743a0a07e");
